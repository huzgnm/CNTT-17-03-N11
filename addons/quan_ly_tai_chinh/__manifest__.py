# -*- coding: utf-8 -*-
{
    ...
    "description": "Module quan ly tai chinh: lap ngan sach, ghi nhan phieu thu/chi, tu dong tao phieu khi bao tri hoan thanh hoac thanh ly duoc duyet. Tich hop Telegram Bot thong bao (Muc 3).",
